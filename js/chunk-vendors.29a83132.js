 ...
 * limitations under the License.
 */
function sd(e){e=eh(e,oh);const t=eh(e.firestore,hh);return zl(fh(t),e._key).then((n=>pd(t,e,n)))}class ad extends Zh{constructor(e){super(),this.firestore=e}convertBytes(e){return new gh(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new oh(this.firestore,null,t)}}function cd(e){e=eh(e,ih);const t=eh(e.firestore,hh),n=fh(t),r=new ad(t);return Bh(e._query),Wl(n,e._query).then((n=>new id(t,r,e,n)))}function ud(e,t,n){e=eh(e,oh);const r=eh(e.firestore,hh),i=ed(e.converter,t,n);return fd(r,[Ah(Sh(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,Zs.none())])}function ld(e){return fd(eh(e.firestore,hh),[new da(e._key,Zs.none())])}function hd(e,t){const n=eh(e.firestore,hh),r=ch(e),i=ed(e.converter,t);return fd(n,[Ah(Sh(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,Zs.exists(!1))]).then((()=>r))}function dd(e,...t){var n,r,i;e=(0,a.m9)(e);let o={includeMetadataChanges:!1},s=0;"object"!=typeof t[s]||lh(t[s])||(o=t[s],s++);const c={includeMetadataChanges:o.includeMetadataChanges};if(lh(t[s])){const e=t[s];t[s]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[s+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[s+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,l,h;if(e instanceof oh)l=eh(e.firestore,hh),h=ss(e._key.path),u={next:n=>{t[s]&&t[s](pd(l,e,n))},error:t[s+1],complete:t[s+2]};else{const n=eh(e,ih);l=eh(n.firestore,hh),h=n._query;const r=new ad(l);u={next:e=>{t[s]&&t[s](new id(l,r,n,e))},error:t[s+1],complete:t[s+2]},Bh(e._query)}return function(e,t,n,r){const i=new Ml(r),o=new sl(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>tl(await Hl(e),o))),()=>{i.Ca(),e.asyncQueue.enqueueAndForget((async()=>nl(await Hl(e),o)))}}(fh(l),h,c,u)}function fd(e,t){return function(e,t){const n=new ci;return e.asyncQueue.enqueueAndForget((async()=>ml(await Bl(e),t,n))),n.promise}(fh(e),t)}function pd(e,t,n){const r=n.docs.get(t._key),i=new ad(e);return new nd(e,i,t._key,r,new td(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
class gd{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=Sh(e)}set(e,t,n){this._verifyNotCommitted();const r=md(e,this._firestore),i=ed(r.converter,t,n),o=Ah(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(o.toMutation(r._key,Zs.none())),this}update(e,t,n,...r){this._verifyNotCommitted();const i=md(e,this._firestore);let o;return o="string"==typeof(t=(0,a.m9)(t))||t instanceof mh?xh(this._dataReader,"WriteBatch.update",i._key,t,n,r):kh(this._dataReader,"WriteBatch.update",i._key,t),this._mutations.push(o.toMutation(i._key,Zs.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=md(e,this._firestore);return this._mutations=this._mutations.concat(new da(t._key,Zs.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new ai(si.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function md(e,t){if((e=(0,a.m9)(e)).firestore!==t)throw new ai(si.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function yd(e){return fh(e=eh(e,hh)),new gd(e,(t=>fd(e,t)))
/**
 * @license
 * Copyright 2021 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.29a83132.js.map