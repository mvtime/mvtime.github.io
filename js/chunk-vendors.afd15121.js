 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ul=/^__.*__$/;class Vl{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new Ss(e,this.data,this.fieldMask,t,this.fieldTransforms):new Is(e,this.data,t,this.fieldTransforms)}}class ql{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new Ss(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function $l(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Mr()}}class Bl{constructor(e,t,n,r,i,o){this.settings=e,this.databaseId=t,this.Tt=n,this.ignoreUndefinedProperties=r,void 0===i&&this.ia(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get ra(){return this.settings.ra}oa(e){return new Bl(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.Tt,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ua(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.oa({path:n,ca:!1});return r.aa(e),r}ha(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.oa({path:n,ca:!1});return r.ia(),r}la(e){return this.oa({path:void 0,ca:!0})}fa(e){return sh(e,this.settings.methodName,this.settings.da||!1,this.path,this.settings._a)}contains(e){return void 0!==this.fieldMask.find((t=>e.isPrefixOf(t)))||void 0!==this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))}ia(){if(this.path)for(let e=0;e<this.path.length;e++)this.aa(this.path.get(e))}aa(e){if(0===e.length)throw this.fa("Document fields must not be empty");if($l(this.ra)&&Ul.test(e))throw this.fa('Document fields cannot begin and end with "__"')}}class Hl{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.Tt=n||Pc(e)}wa(e,t,n,r=!1){return new Bl({ra:e,methodName:t,_a:n,path:oi.emptyPath(),ca:!1,da:r},this.databaseId,this.Tt,this.ignoreUndefinedProperties)}}function zl(e){const t=e._freezeSettings(),n=Pc(e._databaseId);return new Hl(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Wl(e,t,n,r,i,o={}){const s=e.wa(o.merge||o.mergeFields?2:0,t,n,i);nh("Data must be an object, but it was:",s,r);const a=eh(r,s);let c,u;if(o.merge)c=new So(s.fieldMask),u=s.fieldTransforms;else if(o.mergeFields){const e=[];for(const r of o.mergeFields){const i=rh(t,r,n);if(!s.contains(i))throw new Vr(Ur.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);ah(e,i)||e.push(i)}c=new So(e),u=s.fieldTransforms.filter((e=>c.covers(e.field)))}else c=null,u=s.fieldTransforms;return new Vl(new ko(a),c,u)}class Kl extends jl{_toFieldTransform(e){if(2!==e.ra)throw 1===e.ra?e.fa(`${this._methodName}() can only appear at the top level of your update data`):e.fa(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Kl}}function Gl(e,t,n){return new Bl({ra:3,_a:t.settings._a,methodName:e._methodName,ca:n},t.databaseId,t.Tt,t.ignoreUndefinedProperties)}class Jl extends jl{constructor(e,t){super(e),this.ma=t}_toFieldTransform(e){const t=Gl(this,e,!0),n=this.ma.map((e=>Zl(e,t))),r=new ss(n);return new ds(e.path,r)}isEqual(e){return this===e}}function Ql(e,t,n,r){const i=e.wa(1,t,n);nh("Data must be an object, but it was:",i,r);const o=[],s=ko.empty();Ei(r,((e,r)=>{const c=oh(t,e,n);r=(0,a.m9)(r);const u=i.ha(c);if(r instanceof Kl)o.push(c);else{const e=Zl(r,u);null!=e&&(o.push(c),s.set(c,e))}}));const c=new So(o);return new ql(s,c,i.fieldTransforms)}function Xl(e,t,n,r,i,o){const s=e.wa(1,t,n),c=[rh(t,r,n)],u=[i];if(o.length%2!=0)throw new Vr(Ur.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let a=0;a<o.length;a+=2)c.push(rh(t,o[a])),u.push(o[a+1]);const l=[],h=ko.empty();for(let d=c.length-1;d>=0;--d)if(!ah(l,c[d])){const e=c[d];let t=u[d];t=(0,a.m9)(t);const n=s.ha(e);if(t instanceof Kl)l.push(e);else{const r=Zl(t,n);null!=r&&(l.push(e),h.set(e,r))}}const f=new So(l);return new ql(h,f,s.fieldTransforms)}function Yl(e,t,n,r=!1){return Zl(n,e.wa(r?4:3,t))}function Zl(e,t){if(th(e=(0,a.m9)(e)))return nh("Unsupported field value:",t,e),eh(e,t);if(e instanceof jl)return function(e,t){if(!$l(t.ra))throw t.fa(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.fa(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.ca&&4!==t.ra)throw t.fa("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const i of e){let e=Zl(i,t.la(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=(0,a.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return es(t.Tt,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=ei.fromDate(e);return{timestampValue:ua(t.Tt,n)}}if(e instanceof ei){const n=new ei(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:ua(t.Tt,n)}}if(e instanceof Fl)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof Ll)return{bytesValue:la(t.Tt,e._byteString)};if(e instanceof Il){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.fa(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:da(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.fa(`Unsupported field value: ${wl(e)}`)}(e,t)}function eh(e,t){const n={};return _i(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Ei(e,((e,r)=>{const i=Zl(r,t.ua(e));null!=i&&(n[e]=i)})),{mapValue:{fields:n}}}function th(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof ei||e instanceof Fl||e instanceof Ll||e instanceof Il||e instanceof jl)}function nh(e,t,n){if(!th(n)||!function(e){return"object"==typeof e&&null!==e&&(Object.getPrototypeOf(e)===Object.prototype||null===Object.getPrototypeOf(e))}(n)){const r=wl(n);throw"an object"===r?t.fa(e+" a custom object"):t.fa(e+" "+r)}}function rh(e,t,n){if((t=(0,a.m9)(t))instanceof Ml)return t._internalPath;if("string"==typeof t)return oh(e,t);throw sh("Field path arguments must be of type string or ",e,!1,void 0,n)}const ih=new RegExp("[~\\*/\\[\\]]");function oh(e,t,n){if(t.search(ih)>=0)throw sh(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new Ml(...t.split("."))._internalPath}catch(r){throw sh(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function sh(e,t,n,r,i){const o=r&&!r.isEmpty(),s=void 0!==i;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(o||s)&&(c+=" (found",o&&(c+=` in field ${r}`),s&&(c+=` in document ${i}`),c+=")"),new Vr(Ur.INVALID_ARGUMENT,a+e+c)}function ah(e,t){return e.some((e=>e.isEqual(t)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hh(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new Vr(Ur.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class fh{}class dh extends fh{}function ph(e,t,...n){let r=[];t instanceof fh&&r.push(t),r=r.concat(n),function(e){const t=e.filter((e=>e instanceof mh)).length,n=e.filter((e=>e instanceof gh)).length;if(t>1||t>0&&n>0)throw new Vr(Ur.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _h(e,t,n){let r;return r=e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t,r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ch(e){e=bl(e,Il);const t=bl(e.firestore,Nl);return fl(Dl(t),e._key).then((n=>Lh(t,e,n)))}class xh extends Eh{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ll(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Il(this.firestore,null,t)}}function Oh(e){e=bl(e,Sl);const t=bl(e.firestore,Nl),n=Dl(t),r=new xh(t);return hh(e._query),dl(n,e._query).then((n=>new kh(t,r,e,n)))}function Nh(e,t,n){e=bl(e,Il);const r=bl(e.firestore,Nl),i=_h(e.converter,t,n);return Ph(r,[Wl(zl(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,ms.none())])}function Rh(e,t){const n=bl(e.firestore,Nl),r=Cl(e),i=_h(e.converter,t);return Ph(n,[Wl(zl(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,ms.exists(!1))]).then((()=>r))}function Dh(e,...t){var n,r,i;e=(0,a.m9)(e);let o={includeMetadataChanges:!1},s=0;"object"!=typeof t[s]||Ol(t[s])||(o=t[s],s++);const c={includeMetadataChanges:o.includeMetadataChanges};if(Ol(t[s])){const e=t[s];t[s]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[s+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[s+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,l,h;if(e instanceof Il)l=bl(e.firestore,Nl),h=Mo(e._key.path),u={next:n=>{t[s]&&t[s](Lh(l,e,n))},error:t[s+1],complete:t[s+2]};else{const n=bl(e,Sl);l=bl(n.firestore,Nl),h=n._query;const r=new xh(l);u={next:e=>{t[s]&&t[s](new kh(l,r,n,e))},error:t[s+1],complete:t[s+2]},hh(e._query)}return function(e,t,n,r){const i=new il(r),o=new Cu(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>Tu(await hl(e),o))),()=>{i.Pc(),e.asyncQueue.enqueueAndForget((async()=>Iu(await hl(e),o)))}}(Dl(l),h,c,u)}function Ph(e,t){return function(e,t){const n=new qr;return e.asyncQueue.enqueueAndForget((async()=>Fu(await ll(e),t,n))),n.promise}(Dl(e),t)}function Lh(e,t,n){const r=n.docs.get(t._key),i=new xh(e);return new Ih(e,i,t._key,r,new Th(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
class Mh{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=zl(e)}set(e,t,n){this._verifyNotCommitted();const r=jh(e,this._firestore),i=_h(r.converter,t,n),o=Wl(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(o.toMutation(r._key,ms.none())),this}update(e,t,n,...r){this._verifyNotCommitted();const i=jh(e,this._firestore);let o;return o="string"==typeof(t=(0,a.m9)(t))||t instanceof Ml?Xl(this._dataReader,"WriteBatch.update",i._key,t,n,r):Ql(this._dataReader,"WriteBatch.update",i._key,t),this._mutations.push(o.toMutation(i._key,ms.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=jh(e,this._firestore);return this._mutations=this._mutations.concat(new xs(t._key,ms.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new Vr(Ur.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function jh(e,t){if((e=(0,a.m9)(e)).firestore!==t)throw new Vr(Ur.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fh(...e){return new Jl("arrayUnion",e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Uh(e){return Dl(e=bl(e,Nl)),new Mh(e,(t=>Ph(e,t)))
/**
 * @license
 * Copyright 2021 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.afd15121.js.map