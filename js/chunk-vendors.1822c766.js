 ...
 * limitations under the License.
 */
function Th(e){e=wl(e,_l);const t=wl(e.firestore,Nl);return hl(Dl(t),e._key).then((n=>Ah(t,e,n)))}class Eh extends ph{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ll(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new _l(this.firestore,null,t)}}function _h(e){e=wl(e,Il);const t=wl(e.firestore,Nl),n=Dl(t),r=new Eh(t);return ih(e._query),dl(n,e._query).then((n=>new wh(t,r,e,n)))}function Ih(e,t,n){e=wl(e,_l);const r=wl(e.firestore,Nl),i=gh(e.converter,t,n);return kh(r,[Hl(Bl(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,go.none())])}function Sh(e,t){const n=wl(e.firestore,Nl),r=kl(e),i=gh(e.converter,t);return kh(n,[Hl(Bl(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,go.exists(!1))]).then((()=>r))}function Ch(e,...t){var n,r,i;e=(0,a.m9)(e);let s={includeMetadataChanges:!1},o=0;"object"!=typeof t[o]||xl(t[o])||(s=t[o],o++);const c={includeMetadataChanges:s.includeMetadataChanges};if(xl(t[o])){const e=t[o];t[o]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[o+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[o+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,l,h;if(e instanceof _l)l=wl(e.firestore,Nl),h=Ps(e._key.path),u={next:n=>{t[o]&&t[o](Ah(l,e,n))},error:t[o+1],complete:t[o+2]};else{const n=wl(e,Il);l=wl(n.firestore,Nl),h=n._query;const r=new Eh(l);u={next:e=>{t[o]&&t[o](new wh(l,r,n,e))},error:t[o+1],complete:t[o+2]},ih(e._query)}return function(e,t,n,r){const i=new rl(r),s=new ku(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>Eu(await ll(e),s))),()=>{i.Pc(),e.asyncQueue.enqueueAndForget((async()=>_u(await ll(e),s)))}}(Dl(l),h,c,u)}function kh(e,t){return function(e,t){const n=new qr;return e.asyncQueue.enqueueAndForget((async()=>Fu(await ul(e),t,n))),n.promise}(Dl(e),t)}function Ah(e,t,n){const r=n.docs.get(t._key),i=new Eh(e);return new yh(e,i,t._key,r,new mh(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.1822c766.js.map