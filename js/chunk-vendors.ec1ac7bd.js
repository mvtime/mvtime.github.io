 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sa=new Kr([4294967295,4294967295],0);function Aa(e){const t=Ia().encode(e),n=new Wr;return n.update(t),new Uint8Array(n.digest())}function Ca(e){const t=new DataView(e.buffer),n=t.getUint32(0,!0),r=t.getUint32(4,!0),i=t.getUint32(8,!0),o=t.getUint32(12,!0);return[new Kr([n,r],0),new Kr([i,o],0)]}class ka{constructor(e,t,n){if(this.bitmap=e,this.padding=t,this.hashCount=n,t<0||t>=8)throw new xa(`Invalid padding: ${t}`);if(n<0)throw new xa(`Invalid hash count: ${n}`);if(e.length>0&&0===this.hashCount)throw new xa(`Invalid hash count: ${n}`);if(0===e.length&&0!==t)throw new xa(`Invalid padding when bitmap length is 0: ${t}`);this.de=8*e.length-t,this.Ae=Kr.fromNumber(this.de)}Re(e,t,n){let r=e.add(t.multiply(Kr.fromNumber(n)));return 1===r.compare(Sa)&&(r=new Kr([r.getBits(0),r.getBits(1)],0)),r.modulo(this.Ae).toNumber()}Ve(e){return 0!=(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(0===this.de)return!1;const t=Aa(e),[n,r]=Ca(t);for(let i=0;i<this.hashCount;i++){const e=this.Re(n,r,i);if(!this.Ve(e))return!1}return!0}static create(e,t,n){const r=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),o=new ka(i,r,t);return n.forEach((e=>o.insert(e))),o}insert(e){if(0===this.de)return;const t=Aa(e),[n,r]=Ca(t);for(let i=0;i<this.hashCount;i++){const e=this.Re(n,r,i);this.me(e)}}me(e){const t=Math.floor(e/8),n=e%8;this.bitmap[t]|=1<<n}}class xa extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ec{constructor(){}Pt(e,t){this.It(e,t),t.Tt()}It(e,t){if("nullValue"in e)this.Et(t,5);else if("booleanValue"in e)this.Et(t,10),t.dt(e.booleanValue?1:0);else if("integerValue"in e)this.Et(t,15),t.dt(io(e.integerValue));else if("doubleValue"in e){const n=io(e.doubleValue);isNaN(n)?this.Et(t,13):(this.Et(t,15),Vi(n)?t.dt(0):t.dt(n))}else if("timestampValue"in e){const n=e.timestampValue;this.Et(t,20),"string"==typeof n?t.At(n):(t.At(`${n.seconds||""}`),t.dt(n.nanos||0))}else if("stringValue"in e)this.Rt(e.stringValue,t),this.Vt(t);else if("bytesValue"in e)this.Et(t,30),t.ft(oo(e.bytesValue)),this.Vt(t);else if("referenceValue"in e)this.gt(e.referenceValue,t);else if("geoPointValue"in e){const n=e.geoPointValue;this.Et(t,45),t.dt(n.latitude||0),t.dt(n.longitude||0)}else"mapValue"in e?Co(e)?this.Et(t,Number.MAX_SAFE_INTEGER):(this.yt(e.mapValue,t),this.Vt(t)):"arrayValue"in e?(this.wt(e.arrayValue,t),this.Vt(t)):ri()}Rt(e,t){this.Et(t,25),this.St(e,t)}St(e,t){t.At(e)}yt(e,t){const n=e.fields||{};this.Et(t,55);for(const r of Object.keys(n))this.Rt(r,t),this.It(n[r],t)}wt(e,t){const n=e.values||[];this.Et(t,50);for(const r of n)this.It(r,t)}gt(e,t){this.Et(t,37),Ci.fromName(e).path.forEach((e=>{this.Et(t,60),this.St(e,t)}))}Et(e,t){e.dt(t)}Vt(e){e.dt(2)}}Ec.bt=new Ec;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class Cc{constructor(){this.changes=new Es((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Oo.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return void 0!==n?Mi.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nc{constructor(){this.lr=new Xi(Dc.hr),this.Pr=new Xi(Dc.Ir)}isEmpty(){return this.lr.isEmpty()}addReference(e,t){const n=new Dc(e,t);this.lr=this.lr.add(n),this.Pr=this.Pr.add(n)}Tr(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.Er(new Dc(e,t))}dr(e,t){e.forEach((e=>this.removeReference(e,t)))}Ar(e){const t=new Ci(new Ii([])),n=new Dc(t,e),r=new Dc(t,e+1),i=[];return this.Pr.forEachInRange([n,r],(e=>{this.Er(e),i.push(e.key)})),i}Rr(){this.lr.forEach((e=>this.Er(e)))}Er(e){this.lr=this.lr.delete(e),this.Pr=this.Pr.delete(e)}Vr(e){const t=new Ci(new Ii([])),n=new Dc(t,e),r=new Dc(t,e+1);let i=Ds();return this.Pr.forEachInRange([n,r],(e=>{i=i.add(e.key)})),i}containsKey(e){const t=new Dc(e,0),n=this.lr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class Dc{constructor(e,t){this.key=e,this.mr=t}static hr(e,t){return Ci.comparator(e.key,t.key)||wi(e.mr,t.mr)}static Ir(e,t){return wi(e.mr,t.mr)||Ci.comparator(e.key,t.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class $c{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Li=n,this.ki=r}static qi(e,t){let n=Ds(),r=Ds();for(const i of t.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:r=r.add(i.doc.key)}return new $c(e,t.fromCache,n,r)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function du(e){return new qa(e,!0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wu{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.g_=[],this.p_=new Map,this.y_=new Set,this.w_=[],this.S_=i,this.S_.Ys((e=>{n.enqueueAndForget((async()=>{ku(this)&&(Zr("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=oi(e);t.y_.add(4),await _u(t),t.b_.set("Unknown"),t.y_.delete(4),await bu(t)}(this))}))})),this.b_=new vu(n,r)}}async function bu(e){if(ku(e))for(const t of e.w_)await t(!0)}async function _u(e){for(const t of e.w_)await t(!1)}function Eu(e,t){const n=oi(e);n.p_.has(t.targetId)||(n.p_.set(t.targetId,t),Cu(n)?Au(n):Wu(n).Uo()&&Iu(n,t))}function Tu(e,t){const n=oi(e),r=Wu(n);n.p_.delete(t),r.Uo()&&Su(n,t),0===n.p_.size&&(r.Uo()?r.zo():ku(n)&&n.b_.set("Unknown"))}function Iu(e,t){if(e.D_.Be(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(Ei.min())>0){const n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}Wu(e).i_(t)}function Su(e,t){e.D_.Be(t),Wu(e).s_(t)}function Au(e){e.D_=new Ma({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),ut:t=>e.p_.get(t)||null,rt:()=>e.datastore.serializer.databaseId}),Wu(e).start(),e.b_.A_()}function Cu(e){return ku(e)&&!Wu(e).$o()&&e.p_.size>0}function ku(e){return 0===oi(e).y_.size}function xu(e){e.D_=void 0}async function Ou(e){e.p_.forEach(((t,n)=>{Iu(e,t)}))}async function Ru(e,t){xu(e),Cu(e)?(e.b_.m_(t),Au(e)):e.b_.set("Unknown")}async function Nu(e,t,n){if(e.b_.set("Online"),t instanceof Pa&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const r of t.targetIds)e.p_.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.p_.delete(r),e.D_.removeTarget(r))}(e,t)}catch(n){Zr("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),n),await Du(e,n)}else if(t instanceof Na?e.D_.We(t):t instanceof Da?e.D_.Ze(t):e.D_.je(t),!n.isEqual(Ei.min()))try{const t=await Kc(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.D_.st(t);return n.targetChanges.forEach(((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=e.p_.get(r);i&&e.p_.set(r,i.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach(((t,n)=>{const r=e.p_.get(t);if(!r)return;e.p_.set(t,r.withResumeToken(to.EMPTY_BYTE_STRING,r.snapshotVersion)),Su(e,t);const i=new wc(r.target,t,n,r.sequenceNumber);Iu(e,i)})),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){Zr("RemoteStore","Failed to raise snapshot:",t),await Du(e,t)}}async function Du(e,t,n){if(!ji(t))throw t;e.y_.add(1),await _u(e),e.b_.set("Offline"),n||(n=()=>Kc(e.localStore)),e.asyncQueue.enqueueRetryable((async()=>{Zr("RemoteStore","Retrying IndexedDB access"),await n(),e.y_.delete(1),await bu(e)}))}function Pu(e,t){return t().catch((n=>Du(e,n,t)))}async function Lu(e){const t=oi(e),n=Ku(t);let r=t.g_.length>0?t.g_[t.g_.length-1].batchId:-1;for(;Mu(t);)try{const e=await Jc(t.localStore,r);if(null===e){0===t.g_.length&&n.zo();break}r=e.batchId,ju(t,e)}catch(e){await Du(t,e)}Fu(t)&&Uu(t)}function Mu(e){return ku(e)&&e.g_.length<10}function ju(e,t){e.g_.push(t);const n=Ku(e);n.Uo()&&n.__&&n.a_(t.mutations)}function Fu(e){return ku(e)&&!Ku(e).$o()&&e.g_.length>0}function Uu(e){Ku(e).start()}async function Vu(e){Ku(e).l_()}async function $u(e){const t=Ku(e);for(const n of e.g_)t.a_(n.mutations)}async function qu(e,t,n){const r=e.g_.shift(),i=ga.from(r,t,n);await Pu(e,(()=>e.remoteSyncer.applySuccessfulWrite(i))),await Lu(e)}async function Bu(e,t){t&&Ku(e).__&&await async function(e,t){if(function(e){return ba(e)&&e!==si.ABORTED}(t.code)){const n=e.g_.shift();Ku(e).Go(),await Pu(e,(()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t))),await Lu(e)}}(e,t),Fu(e)&&Uu(e)}async function Hu(e,t){const n=oi(e);n.asyncQueue.verifyOperationInProgress(),Zr("RemoteStore","RemoteStore received new credentials");const r=ku(n);n.y_.add(3),await _u(n),r&&n.b_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.y_.delete(3),await bu(n)}async function zu(e,t){const n=oi(e);t?(n.y_.delete(2),await bu(n)):t||(n.y_.add(2),await _u(n),n.b_.set("Unknown"))}function Wu(e){return e.v_||(e.v_=function(e,t,n){const r=oi(e);return r.P_(),new gu(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}(e.datastore,e.asyncQueue,{_o:Ou.bind(null,e),uo:Ru.bind(null,e),r_:Nu.bind(null,e)}),e.w_.push((async t=>{t?(e.v_.Go(),Cu(e)?Au(e):e.b_.set("Unknown")):(await e.v_.stop(),xu(e))}))),e.v_}function Ku(e){return e.C_||(e.C_=function(e,t,n){const r=oi(e);return r.P_(),new mu(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(e.datastore,e.asyncQueue,{_o:Vu.bind(null,e),uo:Bu.bind(null,e),c_:$u.bind(null,e),u_:qu.bind(null,e)}),e.w_.push((async t=>{t?(e.C_.Go(),await Lu(e)):(await e.C_.stop(),e.g_.length>0&&(Zr("RemoteStore",`Stopping write stream with ${e.g_.length} pending writes`),e.g_=[]))}))),e.C_
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function sd(e){e=eh(e,oh);const t=eh(e.firestore,hh);return zl(fh(t),e._key).then((n=>gd(t,e,n)))}class ad extends Zh{constructor(e){super(),this.firestore=e}convertBytes(e){return new gh(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new oh(this.firestore,null,t)}}function cd(e){e=eh(e,ih);const t=eh(e.firestore,hh),n=fh(t),r=new ad(t);return Bh(e._query),Wl(n,e._query).then((n=>new id(t,r,e,n)))}function ud(e,t,n){e=eh(e,oh);const r=eh(e.firestore,hh),i=ed(e.converter,t,n);return pd(r,[Ah(Sh(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,Zs.none())])}function ld(e,t,n,...r){e=eh(e,oh);const i=eh(e.firestore,hh),o=Sh(i);let s;return s="string"==typeof(t=(0,a.m9)(t))||t instanceof mh?xh(o,"updateDoc",e._key,t,n,r):kh(o,"updateDoc",e._key,t),pd(i,[s.toMutation(e._key,Zs.exists(!0))])}function hd(e){return pd(eh(e.firestore,hh),[new da(e._key,Zs.none())])}function dd(e,t){const n=eh(e.firestore,hh),r=ch(e),i=ed(e.converter,t);return pd(n,[Ah(Sh(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,Zs.exists(!1))]).then((()=>r))}function fd(e,...t){var n,r,i;e=(0,a.m9)(e);let o={includeMetadataChanges:!1},s=0;"object"!=typeof t[s]||lh(t[s])||(o=t[s],s++);const c={includeMetadataChanges:o.includeMetadataChanges};if(lh(t[s])){const e=t[s];t[s]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[s+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[s+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,l,h;if(e instanceof oh)l=eh(e.firestore,hh),h=ss(e._key.path),u={next:n=>{t[s]&&t[s](gd(l,e,n))},error:t[s+1],complete:t[s+2]};else{const n=eh(e,ih);l=eh(n.firestore,hh),h=n._query;const r=new ad(l);u={next:e=>{t[s]&&t[s](new id(l,r,n,e))},error:t[s+1],complete:t[s+2]},Bh(e._query)}return function(e,t,n,r){const i=new Ml(r),o=new sl(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>tl(await Hl(e),o))),()=>{i.Ca(),e.asyncQueue.enqueueAndForget((async()=>nl(await Hl(e),o)))}}(fh(l),h,c,u)}function pd(e,t){return function(e,t){const n=new ci;return e.asyncQueue.enqueueAndForget((async()=>ml(await Bl(e),t,n))),n.promise}(fh(e),t)}function gd(e,t,n){const r=n.docs.get(t._key),i=new ad(e);return new nd(e,i,t._key,r,new td(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
class md{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=Sh(e)}set(e,t,n){this._verifyNotCommitted();const r=yd(e,this._firestore),i=ed(r.converter,t,n),o=Ah(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(o.toMutation(r._key,Zs.none())),this}update(e,t,n,...r){this._verifyNotCommitted();const i=yd(e,this._firestore);let o;return o="string"==typeof(t=(0,a.m9)(t))||t instanceof mh?xh(this._dataReader,"WriteBatch.update",i._key,t,n,r):kh(this._dataReader,"WriteBatch.update",i._key,t),this._mutations.push(o.toMutation(i._key,Zs.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=yd(e,this._firestore);return this._mutations=this._mutations.concat(new da(t._key,Zs.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new ai(si.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function yd(e,t){if((e=(0,a.m9)(e)).firestore!==t)throw new ai(si.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function vd(e){return fh(e=eh(e,hh)),new md(e,(t=>pd(e,t)))
/**
 * @license
 * Copyright 2021 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.ec1ac7bd.js.map